...
- Railway Config-as-Code now pins Web, API, Worker, Temporal, and Backup to one Singapore replica. Backup is a terminating Sunday 18:43 UTC cron, and a secret-safe per-service preflight validates production variables before deployment.
